...
#pragma prefast( suppress: 28107, "prefast cannot work out the Dcb must be held at this point" )
...
#pragma prefast( suppress: 28107, "prefast is having problems figuring out the Dcb is acquired" )
        FatReleaseFcb( IrpContext, Dcb );
