...

{
    ...
    //
    //  This should never happen __except in very specific cases (during volume
...
#pragma prefast( suppress:28109, "prefast cannot work out the Fcb is not already held" );
