...

{
    ...
    __except(FatExceptionFilter( NULL, GetExceptionInformation() )) {
...
#pragma prefast( suppress: 28107, "prefast is having problems working out that CurrentVcb->Resource has been acquired at this point." )
                    ExReleaseResourceLite( &CurrentVcb->Resource);
                    CurrentVcb = NULL;
                }
            //
        ...
        //
        //  Call the common Close routine.  Protected in a __try {} __except {}
        //
