...

    ...
    //
    //  Use a __try-__finally to free Fcb/Dcb and buffers on the way out.
    //
                    ...
                    if (FcbOrDcb->Header.AllocationSize.LowPart != 0 ) {
                        ...
                        if (ClusterAlignedFileSize != 0) {
                            ...
                            if (ApproximateClusterCount <= Vcb->AllocationSupport.NumberOfFreeClusters) {
                                ...
                                } __except( GetExceptionCode() == STATUS_DISK_FULL ?
...
#pragma prefast( push )
#pragma prefast( disable: 28107, "we should already be in the critical section" )
